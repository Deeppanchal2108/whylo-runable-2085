...
(function(){
  ...
  // ── SOCIAL LINKS INIT ──
  // Hide buttons with empty/missing href; show when URL added via editor
  ...
  function enableEditor() {
    ...
    document.querySelectorAll('.editable-image, .hero-bg, .about-img-main').forEach(img => {
